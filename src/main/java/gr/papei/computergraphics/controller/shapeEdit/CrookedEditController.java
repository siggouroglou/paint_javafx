...
import gr.papei.computergraphics.lib.shape.model.Crooked;
import java.net.URL;
 ...
 * @author siggouroglou
 */
public class CrookedEditController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        assert shapePropertyColor != null : "fx:id=\"shapePropertyColor\" was not injected: check your FXML file 'CrookedEdit.fxml'.";
        assert pointListNode != null : "fx:id=\"pointListNode\" was not injected: check your FXML file 'CrookedEdit.fxml'.";
        assert errorLabel != null : "fx:id=\"errorLabel\" was not injected: check your FXML file 'CrookedEdit.fxml'.";
    }

    @FXML
    void cancelClick(ActionEvent event) {
        crooked = null; //remove reference.
    ...
    void saveClick(ActionEvent event) {
        ...
        crooked.setPointList(pointList);
        crooked.setLineColor(shapePropertyColor.getValue());
        ...
        ShapeListManager.getInstance().reDrawShape(crooked);
    ...
    public void setCrooked(Crooked crooked) {
        this.crooked = crooked;

        // Load data to view.
        shapePropertyColor.setValue(crooked.getLineColor());

        // Initialize the point list node.
        StringBuilder builder = new StringBuilder();
        for (Point point : crooked.getPointList()) {
            builder.append("(")
