...
import gr.unipi.computergraphics.controller.shapeEdit.SquareEditController;
...
public final class Square implements Shape {
    ...
    public ShapeListItemEditStrategy getEditStrategy() {
        ...
        return () -> {
            ...
            lineEditStage.setTitle("Επεξεργασία Τετραγώνου");
            lineEditStage.getIcons().add(new Image("/files/images/unipi_logo.jpg"));
            lineEditStage.setResizable(false);

            // Load the view.
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/frames/shapeEdit/SquareEdit.fxml"));
            Parent root = (Parent) loader.load();
            lineEditStage.setScene(new Scene(root));

            // Set the contollerreference to this line.
            SquareEditController controller = (SquareEditController) loader.getController();
    ...
    public String getImageFilePath() {
        return "/files/images/shapeSquare.png";
    }
